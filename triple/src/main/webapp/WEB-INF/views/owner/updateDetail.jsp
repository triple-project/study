...
<head>
   ...
   <script type="text/javascript">
      ...
      function upsd() {
         ...
         var updatedsub = document.getElementById('updatedsub')
         document.getElementById('pd_contents').value = updatedsub.innerHTML;
      ...
      <div class="sec_in">
         ...
         <form action="/admin/updateProD" method="post" enctype="multipart/form-data" onclick="upsd()">
            ...
            <ul>
               ...
               <li>
                  <h2>객실설명</h2>
                  <div class="upword" contenteditable="true" id="updatedsub">
                     <p>${pdvo.pd_contents}</p>
                  </div>
